...
namespace Dapper.Easies
{
    internal class DefaultSqlConverter : ISqlConverter
    {
        ...
        public string ToInsertSql<T>(out bool hasIdentityKey)
        {
            ...
            //    properties.Select(o => $"@{o.PropertyInfo.Name}")),
            //    hasIdentityKey);
            //if (_options.DevelopmentMode)
            //    _logger?.LogSql(sql);
            //return sql;
        ...
        //                if (binding is MemberAssignment assignment)
        //                {
        //                    fields.Add(sqlSyntax.AliasPropertyName(new DbAlias(ExpressionParser.GetExpression(assignment.Expression, builder, sqlSyntax, context, lambda?.Parameters), assignment.Member.Name, true)));
        //                }
        //                else
        //                    throw new NotImplementedException($"BindingType：{binding.BindingType}");
        //            }
        ...
        //                fields.Add(sqlSyntax.AliasPropertyName(new DbAlias(ExpressionParser.GetExpression(arg, builder, sqlSyntax, context, lambda?.Parameters), member.Name, true)));
        //            }
        //            return fields;
        //        }
