...
namespace Dapper.Easies.Demo
{
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            await easiesProvider.From<Student>()
                .Join<Class>((a, b) => a.ClassId == b.Id)
                .Join<Class>((a, b, c) => a.ClassId == b.Id)
                .Join<Class>((a, b, c, d) => a.ClassId == b.Id)
                .Join<Class>((a, b, c, d, e) => a.ClassId == b.Id)
                .Join<Class>((a, b, c, d, e, f) => a.ClassId == b.Id)
                .Join<Class>((a, b, c, d, e, f, g) => a.ClassId == b.Id)
                .Join<Class>((a, b, c, d, e, f, g, h) => a.ClassId == b.Id)
                .Join<Class>((a, b, c, d, e, f, g, h, i) => a.ClassId == b.Id)
                .GroupBy((a, b) => b.Name)
                .Having((a, b, c, d, e, f, g, h, i) => DbFunc.Avg(a.Age) > 12)
                .Select((a, b, c, d, e, f, g, h, i) => new { ClassName = b.Name, AvgAge = DbFunc.Avg<decimal>(a.Age) })
                .QueryAsync();
